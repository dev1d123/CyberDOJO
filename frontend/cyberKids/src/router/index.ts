...
const routes = [
  ...
  },
  {
    ...
    meta: { requiresAuth: true, enterAnim: 'animate__fadeIn', leaveAnim: 'animate__fadeOut' },
  },
  {
    path: '/challenges',
    name: 'Challenges',
    component: () => import('../pages/ChallengesPage.vue'),
    meta: { enterAnim: 'animate__fadeInUp', leaveAnim: 'animate__fadeOutDown' },
  },
  {
    path: '/history',
    name: 'History',
    component: HistoryModePage,
    meta: { enterAnim: 'animate__backInLeft', leaveAnim: 'animate__backOutRight' },
  },
  {
  ...
  },
  {
    ...
    name: 'Shop',
    component: ShopPage,
    meta: { enterAnim: 'animate__zoomIn', leaveAnim: 'animate__zoomOut' },
  },
  {
    path: '/profile',
    name: 'Profile',
    component: ProfilePage,
    meta: { requiresAuth: true, enterAnim: 'animate__flipInY', leaveAnim: 'animate__flipOutY' },
  },
  {
